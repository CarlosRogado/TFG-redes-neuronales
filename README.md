...
<p align="center">
  <em>Trabajo de Fin de Grado — Simulación de neuroevolución en el navegador</em>
</p>
...
En `/diagramas/` y en la raíz del proyecto hay 9 diagramas PlantUML listos para usar en la memoria del TFG:

| Diagrama                   | Archivo                                |
|----------------------------|----------------------------------------|
| Clases (unificado)         | `diagrama-clases-unificado.puml`       |
| Clases (general)           | `diagramas/diagrama-clases-general.puml` |
| Clases (específico)        | `diagramas/diagrama-clases-especifico.puml` |
| Secuencia                  | `diagrama-secuencia.puml`              |
| Comportamiento (estados)   | `diagrama-comportamiento.puml`         |
| Arquitectura               | `diagrama-arquitectura.puml`           |
| Actividad                  | `diagrama-actividad.puml`              |
| Estructura de la neurona   | `diagrama-neurona.puml`                |
| Red completa               | `diagrama-red.puml`                    |

Renderízalos con Docker:

```bash
docker run --rm -v "$PWD:/diagrams" plantuml/plantuml -tpng /diagrams/diagrama-clases-unificado.puml
```

---

<div align="center">
  <sub>TFG — Desarrollo de Aplicaciones Web · Víctor Vicente Díaz · 2026</sub>
</div>
