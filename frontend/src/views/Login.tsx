...
export default function Login() {
    ...
    const puedeEnviar = esEmailValido && email !== '' && password !== '';
    ...
    const manejarEnvio = async (e: React.FormEvent) => {
        ...
        try {
            ...
            navigate('/', { state: { toastMessage: '¡Iniciaste sesión exitosamente!' } });
        } catch (err: any) {
          ...
          <form className="space-y-5" onSubmit={manejarEnvio}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-600 px-4 py-3 text-white placeholder:text-gray-500 bg-gray-900/80 focus:outline-none focus:ring-2 focus:border-blue-500 focus:ring-blue-500/40"
                required
              />
            </div>
