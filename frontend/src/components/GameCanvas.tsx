...
export default function GameCanvas({
    ...
    const onCausaMuerteChangeRef = useRef(onCausaMuerteChange); // Referencia para la función de cambio de causas de muerte, permitiendo que la lógica del juego actualice las causas de muerte en el estado del componente
    const onDatosDispersionChangeRef = useRef(onDatosDispersionChange); // Referencia para la función de cambio de datos de dispersión, permitiendo que la lógica del juego actualice los datos de dispersión en el estado del componente
    useEffect(() => {
    ...
    useEffect(() => {
        onDatosDispersionChangeRef.current = onDatosDispersionChange; // Actualiza la referencia de la función de cambio de datos de dispersión cada vez que cambia el estado
    }, [onDatosDispersionChange]);
    useEffect(() => {
